# YOLOv11 Fire and Smoke Detection System

## Body

YOLOv11 Fire and Smoke Detection System Based on Deep Learning YOLOv11 (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model)

nc: 2 classes, name: ['fire', 'smoke'], total image quantity: training set 4832, validation set 1000, test set 912

✅ User Login and Registration: Supports password detection and security verification.

✅ Three detection modes: Based on the YOLOv11 model, supports image, video, and real-time camera detection, accurately recognizes targets.
